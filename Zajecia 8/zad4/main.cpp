...
void test_OperatorDodawania() {
	...
	cout << c << ", SHOULD BE: " << 127456 << endl;
}


void test_OperatorOdejmowania() {
	BigInt a(2);
	a.dodaj(123456);
...
//	test_Pomnoz();
	...
	//test_OperatorDodawania();
	
	test_OperatorOdejmowania();
